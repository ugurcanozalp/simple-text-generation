...
class WebNLGCSV(Dataset):
	...
	def __getitem__(self, i):
		...
		input_ = self.tokenizer.encode_plus(change_case(sample["input_text"]), padding='max_length', truncation=True, max_length=self.max_tokens, return_tensors="pt")
...
if __name__ == "__main__":
	...
	data_path = "../data/webnlg_csv/webNLG2020_dev.csv"
	ds = WebNLGCSV(tokenizer, data_path)
