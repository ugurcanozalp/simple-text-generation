...
val_ds = Spider(model.tokenizer, data_folder="data/spider", phase="dev") 

val_dl = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False,
	num_workers=0)

test_ds = Spider(model.tokenizer, data_folder="data/spider", phase="dev") 
...
# python spider.py --arch t5-small --gradient_clip_val 1.0 --max_epochs 10 --min_epochs 3 --gpus 1
