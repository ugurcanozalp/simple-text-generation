...
from datasets import QA2D, numpy_collate_fn
...
train_ds = QA2D(model.tokenizer, data_path="data/qa2d/train.tsv") 

train_dl = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True,
	num_workers=0)

val_ds = QA2D(model.tokenizer, data_path="data/qa2d/dev.tsv") 

val_dl = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False,
	num_workers=0)

test_ds = QA2D(model.tokenizer, data_path="data/qa2d/dev.tsv") 
...
# python qa2d.py --arch t5-small --gradient_clip_val 1.0 --max_epochs 10 --min_epochs 3 --gpus 1
