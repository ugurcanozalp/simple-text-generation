...
from datasets import WebNLG, numpy_collate_fn
...
train_ds = WebNLG(model.tokenizer, data_path="data/webnlg/train.json") 

train_dl = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True,
	num_workers=0)

val_ds = WebNLG(model.tokenizer, data_path="data/webnlg/dev.json") 

val_dl = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False,
	num_workers=0)

test_ds = WebNLG(model.tokenizer, data_path="data/webnlg/test.json") 
...
# python webnlg.py --arch t5-small --gradient_clip_val 1.0 --max_epochs 10 --min_epochs 3 --gpus 1
